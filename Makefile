...
check_PROGRAMS = test_program$(EXEEXT)
subdir = .
...
program_LDADD = $(LDADD)
am_test_program_OBJECTS = test_func.$(OBJEXT) func.$(OBJEXT)
...
am__v_CXXLD_1 = 
SOURCES = $(program_SOURCES) $(test_program_SOURCES)
DIST_SOURCES = $(program_SOURCES) $(test_program_SOURCES)
...
ACLOCAL = ${SHELL} '/home/diana/Lab3_DevOps/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/diana/Lab3_DevOps/missing' autoconf
AUTOHEADER = ${SHELL} '/home/diana/Lab3_DevOps/missing' autoheader
AUTOMAKE = ${SHELL} '/home/diana/Lab3_DevOps/missing' automake-1.16
AWK = mawk
CC = gcc
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"program\" -DPACKAGE_TARNAME=\"program\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"program\ 1.0\" -DPACKAGE_BUGREPORT=\"rozhko.diana06@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"program\" -DVERSION=\"1.0\" -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/diana/Lab3_DevOps/missing' makeinfo
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/diana/Lab3_DevOps
abs_srcdir = /home/diana/Lab3_DevOps
abs_top_builddir = /home/diana/Lab3_DevOps
abs_top_srcdir = /home/diana/Lab3_DevOps
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/diana/Lab3_DevOps/install-sh
...
test_program$(EXEEXT): $(test_program_OBJECTS) $(test_program_DEPENDENCIES) $(EXTRA_test_program_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(CXXLINK) $(test_program_OBJECTS) $(test_program_LDADD) $(LIBS)
...
include ./$(DEPDIR)/test_func.Po # am--include-marker
...
recheck: all $(check_PROGRAMS)
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
test_func.cpp.log: test_func.cpp
	@p='test_func.cpp'; \
	b='test_func.cpp'; \
